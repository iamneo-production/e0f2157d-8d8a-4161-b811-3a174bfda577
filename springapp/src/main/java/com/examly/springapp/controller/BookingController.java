...
public Booking updateBooking(@PathVariable int bookingId, @RequestBody
Booking booking) {
...
public Payment createPaymentForBooking(@PathVariable int bookingId,
...
@PathVariable int bookingId, @PathVariable int cancellationId, @RequestBody
Cancellation cancellation) {
return bookingService.updateCancellationForBooking(bookingId, cancellationId,
cancellation);
}

@DeleteMapping("/{bookingId}/cancellations/{cancellationId}")
public void deleteCancellationForBooking(@PathVariable int bookingId,
